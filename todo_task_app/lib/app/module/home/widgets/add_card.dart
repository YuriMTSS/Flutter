...
import 'package:todo_task_app/app/core/values/colors.dart';
import 'package:todo_task_app/app/data/models/task.dart';
import 'package:todo_task_app/app/module/home/controller.dart';
import 'package:todo_task_app/app/module/home/widgets/icons.dart';
                    ...
                    child: TextFormField(
                      ...
                      validator: ((value) {
                        if (value == null || value.trim().isEmpty) {
                          return 'Por favor, informe o tipo da tarefa!';
                        }
                        return null;
                      }),
                    ),
                        ...
                        onPressed: () {
                          if (homeCtrl.formKey.currentState!.validate()) {
                            ...
                            homeCtrl.addTask(task)
                                ? EasyLoading.showSuccess('Criado com sucesso')
                                : EasyLoading.showError('Tarefa duplicada');
                          }
                        },
